CREATE TABLE pueblos (
  ...
  extension 	NUMBER(4,1) 	NOT NULL,
  pob_total 	NUMBER(6) 		NOT NULL,
  pob_hombres 	NUMBER(6) 		NOT NULL,
  pob_mujeres 	NUMBER(6) 		NOT NULL,
  vehiculos 	NUMBER(11) 		NOT NULL,
  lineas_tel 	NUMBER(11) 		NOT NULL
);
